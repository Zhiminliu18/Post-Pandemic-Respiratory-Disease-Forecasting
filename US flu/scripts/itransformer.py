...
def main(horizon, mode, model_name, seed, params,train_end_date,val_end_date,test_end_date,year):
    ...
    itrans_old = train_trans(iTransformer_model, train_data, val_data, num_epochs=params['epoch'], batch_size=params['batch_size'], lr=params['lr'],weight_decay=params['weight_decay'],plot=False) #200 32 0.001 1 1
    ...
    for i in range(90):
        ...
        if '_ol' in mode:
            itrans_new = train_trans(copy.deepcopy(itrans_old), new_train_data, new_train_data, num_epochs=2,
                                   batch_size=4,
        ...
        #         data, itrans_new, test_data, train_scaler, next_date, pm_mode,
        ...
        # prediction
        df_true, df_pred = create_prediction_dataframe(
            data, itrans_new, new_train_data, train_scaler, next_date, 'train',
